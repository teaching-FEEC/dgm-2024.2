...
![Workflow](https://drive.google.com/file/d/1ReUO2nS8wlV9Qu4_g4GLrmAKfuDyc6r2/view?usp=sharing)
...
O material de referência adotado foi [este notebook](/notebooks/train_yourtts.py). A implementação básica da estrutura do dataset e cálculo de embeddings de falante pode ser encontrada em [```1-datasetStructure_speakerEmbeddings```](/TTS-Sotaques/notebooks/1_datasetStructure_speakerEmbeddings.ipynb). 
