...
> A principal motivação para a realização deste trabalho engloba-se na compreensão de que é uma área nova e latente para aplicações futuras em robótica social (robôs humanoides), cidades inteligentes e sistemas inteligentes de transporte.
